...
class VariantSelects extends HTMLElement {
  ...
  onVariantChange() {
    ...
    var thisVariantPrice  = $(".no-js-hidden .price .price__regular dd span.price-item").html();
    var currencySymbol = thisVariantPrice.replace(/[\d,.\s]/g, "");
 //   alert(thisVariantPrice);
    var thisPrice = (variant.price/100).toFixed(2);
    $(".no-js-hidden .price .price__regular dd span.price-item").html(currencySymbol+thisPrice);
    ...
    if(qty > 0 && variant.available){
      ...
      document.querySelector('.inventory-container').classList.add("out-of-stock");
